...
- **Literate Technology (LT)**: computable literacy that maps natural language intent to actions and artifacts. Use LT as the term when we discuss the broader concept beyond infrastructure, while keeping “literate computing” for our interface paradigm case study. Cross-link to Chapters 0, 13, and 14.
